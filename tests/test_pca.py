...
class TestPCA:
    def test_linear(self):
        ...
        x, y = cluster_._axis_of_highest_variance
    ...
    def test_wide_rect(self):
        ...
        np.testing.assert_allclose(cluster_._axis_of_highest_variance, (1, 0))
    ...
    def test_tall_rect(self):
        ...
        np.testing.assert_allclose(cluster_._axis_of_highest_variance, (0, 1))
