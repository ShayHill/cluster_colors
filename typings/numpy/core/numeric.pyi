...
from typing import Any, Literal, NoReturn, SupportsAbs, SupportsIndex, TypeVar, overload, cast
...
_ScalarLike_co = cast(Any, _ScalarLike_co)
ArrayLike = cast(Any, ArrayLike)
...
@overload
def isclose(a: Any, b: Any, rtol: float = ..., atol: float = ..., equal_nan: bool = ...) -> bool_:
    ...

@overload
def isclose(a: Any, b: Any, rtol: float = ..., atol: float = ..., equal_nan: bool = ...) -> NDArray[bool_]:
    ...
