...
from typing import Any, Final, Literal as L, Protocol, SupportsIndex, TypeVar, final, overload, TypeAlias, Any
...
@overload
def array(object: _ArrayType, dtype: None = ..., *, copy: bool | _CopyMode = ..., order: _OrderKACF = ..., subok: L[True], ndmin: int = ..., like: _SupportsArrayFunc = ...) -> _ArrayType:
    ...

@overload
def array(object: _ArrayLike[_SCT], dtype: None = ..., *, copy: bool | _CopyMode = ..., order: _OrderKACF = ..., subok: bool = ..., ndmin: int = ..., like: _SupportsArrayFunc = ...) -> NDArray[_SCT]:
    ...

@overload
def array(object: object, dtype: None = ..., *, copy: bool | _CopyMode = ..., order: _OrderKACF = ..., subok: bool = ..., ndmin: int = ..., like: _SupportsArrayFunc = ...) -> NDArray[Any]:
    ...

@overload
def array(object: Any, dtype: _DTypeLike[_SCT], *, copy: bool | _CopyMode = ..., order: _OrderKACF = ..., subok: bool = ..., ndmin: int = ..., like: _SupportsArrayFunc = ...) -> NDArray[_SCT]:
    ...

@overload
def array(object: Any, dtype: DTypeLike, *, copy: bool | _CopyMode = ..., order: _OrderKACF = ..., subok: bool = ..., ndmin: int = ..., like: _SupportsArrayFunc = ...) -> NDArray[Any]:
    ...

@overload
def zeros(shape: _ShapeLike, dtype: None = ..., order: _OrderCF = ..., *, like: _SupportsArrayFunc = ...) -> NDArray[float64]:
    ...

@overload
def zeros(shape: _ShapeLike, dtype: _DTypeLike[_SCT], order: _OrderCF = ..., *, like: _SupportsArrayFunc = ...) -> NDArray[_SCT]:
    ...

@overload
def zeros(shape: _ShapeLike, dtype: DTypeLike, order: _OrderCF = ..., *, like: _SupportsArrayFunc = ...) -> NDArray[Any]:
    ...

@overload
def empty(shape: _ShapeLike, dtype: None = ..., order: _OrderCF = ..., *, like: _SupportsArrayFunc = ...) -> NDArray[float64]:
    ...

@overload
def empty(shape: _ShapeLike, dtype: _DTypeLike[_SCT], order: _OrderCF = ..., *, like: _SupportsArrayFunc = ...) -> NDArray[_SCT]:
    ...

@overload
def empty(shape: _ShapeLike, dtype: DTypeLike, order: _OrderCF = ..., *, like: _SupportsArrayFunc = ...) -> NDArray[Any]:
    ...
...
@overload
def dot(a: ArrayLike, b: ArrayLike, out: _ArrayType) -> npt.NDArray[np.floating[Any]]:
    ...
...
@overload
def asarray(a: _ArrayLike[_SCT], dtype: None = ..., order: _OrderKACF = ..., *, like: _SupportsArrayFunc = ...) -> NDArray[_SCT]:
    ...

@overload
def asarray(a: object, dtype: None = ..., order: _OrderKACF = ..., *, like: _SupportsArrayFunc = ...) -> NDArray[Any]:
    ...

@overload
def asarray(a: Any, dtype: _DTypeLike[_SCT], order: _OrderKACF = ..., *, like: _SupportsArrayFunc = ...) -> NDArray[_SCT]:
    ...

@overload
def asarray(a: Any, dtype: DTypeLike, order: _OrderKACF = ..., *, like: _SupportsArrayFunc = ...) -> NDArray[Any]:
    ...

@overload
def asanyarray(a: _ArrayType, dtype: None = ..., order: _OrderKACF = ..., *, like: _SupportsArrayFunc = ...) -> _ArrayType:
    ...

@overload
def asanyarray(a: _ArrayLike[_SCT], dtype: None = ..., order: _OrderKACF = ..., *, like: _SupportsArrayFunc = ...) -> NDArray[_SCT]:
    ...

@overload
def asanyarray(a: object, dtype: None = ..., order: _OrderKACF = ..., *, like: _SupportsArrayFunc = ...) -> NDArray[Any]:
    ...

@overload
def asanyarray(a: Any, dtype: _DTypeLike[_SCT], order: _OrderKACF = ..., *, like: _SupportsArrayFunc = ...) -> NDArray[_SCT]:
    ...

@overload
def asanyarray(a: Any, dtype: DTypeLike, order: _OrderKACF = ..., *, like: _SupportsArrayFunc = ...) -> NDArray[Any]:
    ...

@overload
def ascontiguousarray(a: _ArrayLike[_SCT], dtype: None = ..., *, like: _SupportsArrayFunc = ...) -> NDArray[_SCT]:
    ...

@overload
def ascontiguousarray(a: object, dtype: None = ..., *, like: _SupportsArrayFunc = ...) -> NDArray[Any]:
    ...

@overload
def ascontiguousarray(a: Any, dtype: _DTypeLike[_SCT], *, like: _SupportsArrayFunc = ...) -> NDArray[_SCT]:
    ...

@overload
def ascontiguousarray(a: Any, dtype: DTypeLike, *, like: _SupportsArrayFunc = ...) -> NDArray[Any]:
    ...

@overload
def asfortranarray(a: _ArrayLike[_SCT], dtype: None = ..., *, like: _SupportsArrayFunc = ...) -> NDArray[_SCT]:
    ...

@overload
def asfortranarray(a: object, dtype: None = ..., *, like: _SupportsArrayFunc = ...) -> NDArray[Any]:
    ...

@overload
def asfortranarray(a: Any, dtype: _DTypeLike[_SCT], *, like: _SupportsArrayFunc = ...) -> NDArray[_SCT]:
    ...

@overload
def asfortranarray(a: Any, dtype: DTypeLike, *, like: _SupportsArrayFunc = ...) -> NDArray[Any]:
    ...
...
@overload
def fromstring(string: str | bytes, dtype: None = ..., count: SupportsIndex = ..., *, sep: str, like: _SupportsArrayFunc = ...) -> NDArray[float64]:
    ...

@overload
def fromstring(string: str | bytes, dtype: _DTypeLike[_SCT], count: SupportsIndex = ..., *, sep: str, like: _SupportsArrayFunc = ...) -> NDArray[_SCT]:
    ...

@overload
def fromstring(string: str | bytes, dtype: DTypeLike, count: SupportsIndex = ..., *, sep: str, like: _SupportsArrayFunc = ...) -> NDArray[Any]:
    ...
...
@overload
def fromfile(file: str | bytes | os.PathLike[Any] | _IOProtocol, dtype: None = ..., count: SupportsIndex = ..., sep: str = ..., offset: SupportsIndex = ..., *, like: _SupportsArrayFunc = ...) -> NDArray[float64]:
    ...

@overload
def fromfile(file: str | bytes | os.PathLike[Any] | _IOProtocol, dtype: _DTypeLike[_SCT], count: SupportsIndex = ..., sep: str = ..., offset: SupportsIndex = ..., *, like: _SupportsArrayFunc = ...) -> NDArray[_SCT]:
    ...

@overload
def fromfile(file: str | bytes | os.PathLike[Any] | _IOProtocol, dtype: DTypeLike, count: SupportsIndex = ..., sep: str = ..., offset: SupportsIndex = ..., *, like: _SupportsArrayFunc = ...) -> NDArray[Any]:
    ...

@overload
def fromiter(iter: Iterable[Any], dtype: _DTypeLike[_SCT], count: SupportsIndex = ..., *, like: _SupportsArrayFunc = ...) -> NDArray[_SCT]:
    ...

@overload
def fromiter(iter: Iterable[Any], dtype: DTypeLike, count: SupportsIndex = ..., *, like: _SupportsArrayFunc = ...) -> NDArray[Any]:
    ...

@overload
def frombuffer(buffer: _SupportsBuffer, dtype: None = ..., count: SupportsIndex = ..., offset: SupportsIndex = ..., *, like: _SupportsArrayFunc = ...) -> NDArray[float64]:
    ...

@overload
def frombuffer(buffer: _SupportsBuffer, dtype: _DTypeLike[_SCT], count: SupportsIndex = ..., offset: SupportsIndex = ..., *, like: _SupportsArrayFunc = ...) -> NDArray[_SCT]:
    ...

@overload
def frombuffer(buffer: _SupportsBuffer, dtype: DTypeLike, count: SupportsIndex = ..., offset: SupportsIndex = ..., *, like: _SupportsArrayFunc = ...) -> NDArray[Any]:
    ...

@overload
def arange(stop: _IntLike_co, /, *, dtype: None = ..., like: _SupportsArrayFunc = ...) -> NDArray[signedinteger[Any]]:
    ...

@overload
def arange(start: _IntLike_co, stop: _IntLike_co, step: _IntLike_co = ..., dtype: None = ..., *, like: _SupportsArrayFunc = ...) -> NDArray[signedinteger[Any]]:
    ...

@overload
def arange(stop: _FloatLike_co, /, *, dtype: None = ..., like: _SupportsArrayFunc = ...) -> NDArray[floating[Any]]:
    ...

@overload
def arange(start: _FloatLike_co, stop: _FloatLike_co, step: _FloatLike_co = ..., dtype: None = ..., *, like: _SupportsArrayFunc = ...) -> NDArray[floating[Any]]:
    ...

@overload
def arange(stop: _TD64Like_co, /, *, dtype: None = ..., like: _SupportsArrayFunc = ...) -> NDArray[timedelta64]:
    ...

@overload
def arange(start: _TD64Like_co, stop: _TD64Like_co, step: _TD64Like_co = ..., dtype: None = ..., *, like: _SupportsArrayFunc = ...) -> NDArray[timedelta64]:
    ...

@overload
def arange(start: datetime64, stop: datetime64, step: datetime64 = ..., dtype: None = ..., *, like: _SupportsArrayFunc = ...) -> NDArray[datetime64]:
    ...

@overload
def arange(stop: Any, /, *, dtype: _DTypeLike[_SCT], like: _SupportsArrayFunc = ...) -> NDArray[_SCT]:
    ...

@overload
def arange(start: Any, stop: Any, step: Any = ..., dtype: _DTypeLike[_SCT] = ..., *, like: _SupportsArrayFunc = ...) -> NDArray[_SCT]:
    ...

@overload
def arange(stop: Any, /, *, dtype: DTypeLike, like: _SupportsArrayFunc = ...) -> NDArray[Any]:
    ...

@overload
def arange(start: Any, stop: Any, step: Any = ..., dtype: DTypeLike = ..., *, like: _SupportsArrayFunc = ...) -> NDArray[Any]:
    ...
