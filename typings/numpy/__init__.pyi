...
from typing import Any, ClassVar, Final, Generic, IO, Literal as L, NoReturn, Protocol, SupportsComplex, SupportsFloat, SupportsIndex, SupportsInt, TypeVar, Union, final, overload
from numpy import ctypeslib as ctypeslib, fft as fft, lib as lib, linalg as linalg, ma as ma, matrixlib as matrixlib, polynomial as polynomial, random as random, testing as testing, version as version
...
from numpy.core.numerictypes import ScalarType as ScalarType, cast as cast, find_common_type as find_common_type, issctype as issctype, issubclass_ as issubclass_, issubdtype as issubdtype, issubsctype as issubsctype, maximum_sctype as maximum_sctype, nbytes as nbytes, obj2sctype as obj2sctype, sctype2char as sctype2char, typecodes as typecodes
...
class flatiter(Generic[_NdArraySubClass]):
    ...
    @overload
    def __getitem__(self: flatiter[ndarray[Any, dtype[_ScalarType]]], key: int | integer | tuple[int | integer]) -> _ScalarType:
        ...
...
class _ArrayOrScalarCommon:
    ...
    def argsort(self, axis: None | SupportsIndex = ..., kind: None | _SortKind = ..., order: None | str | Sequence[str] = ...) -> ndarray:
        ...
    ...
    @overload
    def clip(self, min: ArrayLike = ..., max: None | ArrayLike = ..., out: None = ..., **kwargs: Any) -> ndarray:
        ...
    ...
    @overload
    def compress(self, a: ArrayLike, axis: None | SupportsIndex = ..., out: None = ...) -> ndarray:
        ...
    ...
    @overload
    def cumprod(self, axis: None | SupportsIndex = ..., dtype: DTypeLike = ..., out: None = ...) -> ndarray:
        ...
    ...
    @overload
    def cumsum(self, axis: Any = ..., dtype: Any = ..., out: None = ...) -> ndarray:
        ...
    
    @overload
    def cumsum(self, axis: Any = ..., dtype: DTypeLike = ..., out: Any = ...) -> _NdArraySubClass:
        ...
...
_SupportsBuffer = Union[bytes, bytearray, memoryview, _array.array[Any], mmap.mmap, NDArray[Any], generic,]
_T = TypeVar("_T")
