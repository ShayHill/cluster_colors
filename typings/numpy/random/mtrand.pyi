...
def randint(low: int, high: None | int = ..., size: None | _ShapeLike = ..., dtype: Any = ..., endpoint: bool = ...) -> ndarray[Any, dtype[int_]]: ...

def random(size: None | _ShapeLike = ...) -> ndarray[Any, dtype[float64]] | float64: ...
