...
from typing import Any, Literal as L, Protocol, SupportsIndex, SupportsInt, TypeGuard, TypeVar, overload, cast, TypeAlias
...
# from numpy._typing import ArrayLike, DTypeLike, NDArray, _ArrayLike, _ArrayLikeDT64_co, _ArrayLikeInt_co, _ComplexLike_co, _DTypeLike, _FloatLike_co, _ScalarLike_co

ArrayLike: TypeAlias = Any
DTypeLike: TypeAlias = Any
NDArray: TypeAlias = Any
_ArrayLike: TypeAlias = Any
_ArrayLikeDT64_co: TypeAlias = Any
_ArrayLikeInt_co: TypeAlias = Any
_ComplexLike_co: TypeAlias = Any
_DTypeLike: TypeAlias = Any
_FloatLike_co: TypeAlias = Any
