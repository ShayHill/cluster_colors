...
@overload
def histogram2d(x: _ArrayLikeFloat_co, y: _ArrayLikeFloat_co, bins: int | Sequence[int] = ..., range: None | _ArrayLikeFloat_co = ..., normed: None | bool = ..., weights: None | _ArrayLikeFloat_co = ..., density: None | bool = ...) -> tuple[NDArray[float64], NDArray[floating[Any]], NDArray[floating[Any]],]:
    ...

@overload
def histogram2d(x: _ArrayLikeComplex_co, y: _ArrayLikeComplex_co, bins: int | Sequence[int] = ..., range: None | _ArrayLikeFloat_co = ..., normed: None | bool = ..., weights: None | _ArrayLikeFloat_co = ..., density: None | bool = ...) -> tuple[NDArray[float64], NDArray[complexfloating[Any, Any]], NDArray[complexfloating[Any, Any]],]:
    ...

@overload
def histogram2d(x: _ArrayLikeComplex_co, y: _ArrayLikeComplex_co, bins: Sequence[_ArrayLikeInt_co], range: None | _ArrayLikeFloat_co = ..., normed: None | bool = ..., weights: None | _ArrayLikeFloat_co = ..., density: None | bool = ...) -> tuple[NDArray[float64], NDArray[Any], NDArray[Any],]:
    ...
