...
from numpy._typing import NDArray, _ArrayLike, _ArrayLikeBool_co, _ArrayLikeComplex_co, _ArrayLikeFloat_co, _ArrayLikeInt_co, _ArrayLikeObject_co, _ArrayLikeUInt_co, _ShapeLike
...
@overload
def apply_along_axis(func1d: Callable[..., _ArrayLike[_SCT]], axis: SupportsIndex, arr: ArrayLike, *args: Any, **kwargs: Any) -> NDArray[_SCT]:
    ...

@overload
def apply_along_axis(func1d: Callable[..., ArrayLike], axis: SupportsIndex, arr: ArrayLike, *args: Any, **kwargs: Any) -> NDArray[Any]:
    ...
