...
from typing import Any, AnyStr, ClassVar, Final, Literal as L, SupportsIndex, TypeVar, Union, overload, type_check_only
...
def assert_array_compare(comparison: _ComparisonFunc, x: ArrayLike, y: ArrayLike, err_msg: str = ..., verbose: bool = ..., header: str = ..., precision: SupportsIndex = ..., equal_nan: bool = ..., equal_inf: bool = ...) -> None:
    ...

def assert_array_equal(x: ArrayLike, y: ArrayLike, err_msg: str = ..., verbose: bool = ...) -> None:
    ...
