...
class _Config:
    ...
    conf_min_features = ...
    conf_features = ...
    def conf_features_partial(self): # -> dict[str, dict[str, str]] | dict[str, dict[str, str] | dict[str, str | bool]] | dict[str, dict[str, str | bool]]:
...
class _Distutils:
    ...
    def dist_test(self, source, flags, macros=...): # -> bool:
        """Return True if 'CCompiler.compile()' able to compile
        a source file with certain flags.
        """
        ...
    
    def dist_info(self): # -> tuple[str, Any | str, str]:
        """
    ...
    @staticmethod
    def dist_log(*args, stderr=...): # -> None:
        """Print a console message"""
        ...
    
    @staticmethod
    def dist_load_module(name, path): # -> ModuleType | None:
...
class _Cache:
    ...
    *factors :
    ...
    def cache_hash(self, *factors): # -> Literal[0]:
        ...
    
    @staticmethod
    def me(cb): # -> (self: Unknown, *args: Unknown, **kwargs: Unknown) -> Unknown:
        """
...
class _CCompiler:
    ...
    def cc_normalize_flags(self, flags): # -> list[Unknown]:
        """
...
class _Feature:
    ...
    def feature_names(self, names=..., force_flags=..., macros=...): # -> set[Unknown]:
        """
    ...
    def feature_is_exist(self, name): # -> bool:
        """
    ...
    def feature_sorted(self, names, reverse=...): # -> list[Unknown]:
        """
    ...
    def feature_implies(self, names, keep_origins=...): # -> set[Unknown]:
        """
    ...
    def feature_implies_c(self, names): # -> set[str] | set[Unknown]:
        """same as feature_implies() but combining 'names'"""
        ...
    
    def feature_ahead(self, names): # -> list[Unknown]:
        """
    ...
    def feature_untied(self, names): # -> list[Unknown]:
        """
    ...
    def feature_get_til(self, names, keyisfalse): # -> list[Unknown]:
        """
    ...
    def feature_detect(self, names): # -> list[Unknown]:
        """
    ...
    @_Cache.me
    def feature_is_supported(self, name, force_flags=..., macros=...): # -> bool:
        """
    ...
    @_Cache.me
    def feature_can_autovec(self, name): # -> list[Unknown] | bool:
        """
    ...
    @_Cache.me
    def feature_extra_checks(self, name): # -> list[Unknown]:
        """
    ...
    def feature_c_preprocessor(self, feature_name, tabs=...): # -> str:
        """
...
class CCompilerOpt(_Config, _Distutils, _Cache, _CCompiler, _Feature, _Parse):
    ...
    """
    def __init__(self, ccompiler, cpu_baseline=..., cpu_dispatch=..., cache_path=...) -> None:
        ...
    ...
    def cpu_baseline_flags(self): # -> list[Unknown]:
        """
        Returns a list of final CPU baseline compiler flags
        """
        ...
    
    def cpu_baseline_names(self): # -> list[Unknown]:
        """
        return a list of final CPU baseline feature names
        """
        ...
    
    def cpu_dispatch_names(self): # -> list[Unknown]:
        """
        return a list of final CPU dispatch feature names
        """
        ...
    
    def try_dispatch(self, sources, src_dir=..., ccompiler=..., **kwargs): # -> list[Unknown]:
        """
    ...
    def report(self, full=...): # -> LiteralString:
        ...
    


def new_ccompiler_opt(compiler, dispatch_hpath, **kwargs): # -> CCompilerOpt:
    """
