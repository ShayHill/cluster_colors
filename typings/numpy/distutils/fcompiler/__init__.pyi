...
from distutils.errors import CompileError, DistutilsExecError, DistutilsModuleError, DistutilsPlatformError, LinkError
from distutils.util import split_quoted, strtobool
from numpy.distutils.ccompiler import CCompiler, gen_lib_options
from numpy.distutils import _shell_utils, log
from numpy.distutils.misc_util import all_strings, get_shared_lib_extension, is_sequence, is_string, make_temp_file
...
def flaglist(s): # -> list[str]:
    ...

def str2bool(s): # -> bool | Literal[0, 1]:
    ...

def is_sequence_of_strings(seq): # -> bool:
    ...
...
class FCompiler(CCompiler):
    ...
    def __copy__(self): # -> Self@FCompiler:
        ...
    
    def copy(self): # -> Self@FCompiler:
        ...
    ...
    def get_flags(self): # -> list[Unknown]:
        """List of flags common to all compiler types."""
        ...
    
    def get_flags_f77(self): # -> list[str]:
        """List of Fortran 77 specific flags."""
        ...
    
    def get_flags_f90(self): # -> list[str]:
        """List of Fortran 90 specific flags."""
        ...
    
    def get_flags_free(self): # -> list[Unknown]:
        """List of Fortran 90 free format specific flags."""
        ...
    
    def get_flags_fix(self): # -> list[str]:
        """List of Fortran 90 fixed format specific flags."""
        ...
    
    def get_flags_linker_so(self): # -> list[str]:
        """List of linker flags to build a shared library."""
        ...
    
    def get_flags_linker_exe(self): # -> list[str]:
        """List of linker flags to build an executable."""
        ...
    
    def get_flags_ar(self): # -> list[str]:
        """List of archiver flags. """
        ...
    
    def get_flags_opt(self): # -> list[Unknown]:
        """List of architecture independent compiler flags."""
        ...
    
    def get_flags_arch(self): # -> list[Unknown]:
        """List of architecture dependent compiler flags."""
        ...
    
    def get_flags_debug(self): # -> list[Unknown]:
    ...
    def module_options(self, module_dirs, module_build_dir): # -> list[Unknown]:
        ...
    ...
    def can_ccompiler_link(self, ccompiler): # -> Literal[True]:
        """
...
fcompiler_class = ...
fcompiler_aliases = ...
def load_all_fcompiler_classes(): # -> None:
    """Cache all the FCompiler classes found in modules in the
    numpy.distutils.fcompiler package.
    """
    ...

def available_fcompilers_for_platform(osname=..., platform=...): # -> list[Unknown]:
    ...
...
failed_fcompilers = ...
def new_fcompiler(plat=..., compiler=..., verbose=..., dry_run=..., force=..., requiref90=..., c_compiler=...): # -> None:
...
def has_f90_header(src): # -> Match[str] | None:
    ...

_f77flags_re = ...
def get_f77flags(src): # -> dict[Unknown, Unknown]:
    """
