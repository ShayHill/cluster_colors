...
def libpaths(paths, bits): # -> list[Unknown]:
...
if sys.platform == 'win32':
    ...
    _include_dirs = ...
    _lib_dirs = ...
    def add_system_root(library_root): # -> None:
...
default_src_dirs = ...
so_ext = ...
def get_standard_file(fname): # -> list[Unknown]:
...
def get_info(name, notfound_action=...): # -> None:
    """
    notfound_action:
      0 - do nothing
...
class system_info:
    ...
    def calc_libraries_info(self): # -> dict[Unknown, Unknown]:
        ...
    ...
    def calc_extra_info(self): # -> dict[Unknown, Unknown]:
    ...
    def get_info(self, notfound_action=...): # -> None:
        """ Return a dictionary with items that are compatible
            with numpy.distutils.setup keyword arguments.
        """
        ...
    
    def get_paths(self, section, key): # -> list[Unknown]:
        ...
    
    def get_lib_dirs(self, key=...): # -> list[Unknown]:
        ...
    
    def get_runtime_lib_dirs(self, key=...): # -> list[Unknown]:
        ...
    
    def get_include_dirs(self, key=...): # -> list[Unknown]:
        ...
    
    def get_src_dirs(self, key=...): # -> list[Unknown]:
        ...
    
    def get_libs(self, key, default): # -> list[Unknown] | list[str | Any]:
        ...
    
    def get_libraries(self, key=...): # -> list[Unknown] | list[str | Any]:
        ...
    
    def library_extensions(self): # -> list[Unknown] | list[Unknown | str]:
        ...
    
    def check_libs(self, lib_dirs, libs, opt_libs=...): # -> dict[str, list[Unknown]] | None:
    ...
    def check_libs2(self, lib_dirs, libs, opt_libs=...): # -> dict[str, list[Unknown]] | None:
        """If static or shared libraries are available then return
        their info dictionary.
    ...
    def combine_paths(self, *args): # -> list[Unknown]:
...
class fftw_info(system_info):
    ...
    ver_info = ...
    def calc_ver_info(self, ver_param): # -> bool:
...
class mkl_info(system_info):
    ...
    dir_env_var = ...
    _lib_mkl = ...
    def get_mkl_rootdir(self): # -> str | None:
        ...
...
def get_atlas_version(**config): # -> tuple[str | Any, dict[Unknown, Unknown]] | tuple[Unknown | Literal['3.2.1_pre3.3.6'] | None, dict[Unknown, Unknown]]:
    ...
...
class blas_info(system_info):
    ...
    def get_cblas_libs(self, info): # -> list[str] | None:
...
class openblas_info(blas_info):
    ...
    notfounderror = BlasNotFoundError
    @property
    def symbol_prefix(self): # -> str | Any:
        ...
    
    @property
    def symbol_suffix(self): # -> str | Any:
        ...
    
    def calc_info(self): # -> None:
        ...
    
    def check_msvc_gfortran_libs(self, library_dirs, libraries): # -> dict[str, list[str] | str] | None:
        ...
    
    def check_symbols(self, info): # -> bool:
        ...
...
class flame_info(system_info):
    ...
    def check_embedded_lapack(self, info): # -> bool:
...
class _pkg_config_info(system_info):
    ...
    version_flag = ...
    cflags_flag = ...
    def get_config_exe(self): # -> str:
        ...
    
    def get_config_output(self, config_exe, option): # -> None:
        ...
...
def combine_paths(*args, **kws): # -> list[Unknown]:
...
def parseCmdLine(argv=...): # -> tuple[Values, list[str]]:
    ...
