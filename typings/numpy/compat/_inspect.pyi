...
def joinseq(seq): # -> LiteralString:
    ...

def strseq(object, convert, join=...): # -> LiteralString:
...
def formatargvalues(args, varargs, varkw, locals, formatarg=..., formatvarargs=..., formatvarkw=..., formatvalue=..., join=...): # -> str:
