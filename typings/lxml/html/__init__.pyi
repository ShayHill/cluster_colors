...
class HtmlMixin:
    ...
    def find_rel_links(self, rel): # -> list[Unknown]:
        """
    ...
    def iterlinks(self): # -> Generator[tuple[Unknown, Literal['codebase'], Unknown, Literal[0]] | tuple[Unknown, Literal['classid', 'data'], Unknown, Literal[0]] | tuple[Unknown, Literal['archive'], Unknown | str, int] | tuple[Unknown, str, Unknown, Literal[0]] | tuple[Unknown, Literal['content'], str | Any | Unknown, int | Unknown] | tuple[Unknown, Literal['value'], Unknown, Literal[0]] | tuple[Unknown, None, str | Any | int, str | Any | int] | tuple[Unknown, Literal['style'], str | Any, int], None, None]:
        """
...
class HtmlElementClassLookup(etree.CustomElementClassLookup):
    ...
    def lookup(self, node_type, document, namespace, name): # -> Type[HtmlElement] | Type[HtmlComment] | Type[HtmlProcessingInstruction] | Type[HtmlEntity] | None:
        ...
...
def fragments_fromstring(html, no_leading_text=..., base_url=..., parser=..., **kw): # -> list[Unknown]:
...
class FormElement(HtmlElement):
    ...
    def form_values(self): # -> list[Unknown]:
        """
...
class SelectElement(InputMixin, HtmlElement):
    ...
    @property
    def value_options(self): # -> list[Unknown]:
        """
...
class MultipleSelectOptions(SetMixin):
    ...
    def __iter__(self): # -> Generator[Unknown | LiteralString, None, None]:
        ...
